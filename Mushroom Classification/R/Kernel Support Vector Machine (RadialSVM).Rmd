---
title: "Kernel Support Vector Machine (RadialSVM)"
...
Fitting Kernel_SVM to the Training set, Predicting the Test set results, and Making the Confusion Matrix
```{r}
library(e1071)
